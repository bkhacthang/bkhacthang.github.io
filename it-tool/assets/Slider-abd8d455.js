import{ay as We,cq as qe,cr as Je,G as D,H as n,J as b,aB as j,bT as he,bg as Ge,bh as Ze,d as Qe,K as eo,L as ge,n as k,a as w,ar as oo,aE as ao,q as fe,ae as to,O as ve,bV as no,bW as ee,R as f,bY as ro,bZ as io,b2 as lo,b_ as so,T as co,aJ as N,b1 as O,b9 as U,b4 as Q}from"./index-2bcc7c92.js";import{u as uo}from"./use-form-item-85f229f3.js";const ho=t=>{const i="rgba(0, 0, 0, .85)",y="0 2px 8px 0 rgba(0, 0, 0, 0.12)",{railColor:v,primaryColor:s,baseColor:d,cardColor:z,modalColor:R,popoverColor:L,borderRadius:K,fontSize:M,opacityDisabled:B}=t;return Object.assign(Object.assign({},qe),{fontSize:M,markFontSize:M,railColor:v,railColorHover:v,fillColor:s,fillColorHover:s,opacityDisabled:B,handleColor:"#FFF",dotColor:z,dotColorModal:R,dotColorPopover:L,handleBoxShadow:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowHover:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowActive:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",handleBoxShadowFocus:"0 1px 4px 0 rgba(0, 0, 0, 0.3), inset 0 0 1px 0 rgba(0, 0, 0, 0.05)",indicatorColor:i,indicatorBoxShadow:y,indicatorTextColor:d,indicatorBorderRadius:K,dotBorder:`2px solid ${v}`,dotBorderActive:`2px solid ${s}`,dotBoxShadow:""})},fo={name:"Slider",common:We,self:ho},vo=fo;function be(t){return window.TouchEvent&&t instanceof window.TouchEvent}function me(){const t=new Map,i=y=>v=>{t.set(y,v)};return Je(()=>{t.clear()}),[t,i]}const bo=D([n("slider",`
 display: block;
